...
<img width="133" height="188" title="treefingers  2_0_5 small screen scaling  floats.25 m; {133x188 pixels})" src="https://github.com/user-attachments/assets/a952b603-cb8b-4eb9-aa4a-fccdb5b6c240" />
  ...
  - [x] locus mismatch (examplified by overlay's `preview glyph`) <img title="treefingers  2_0_8  locus mismatch" src="https://github.com/user-attachments/assets/231c441b-b0bf-4bef-b989-ffcd1fb2b5e5" width="400" />; [FIXED in 2-0-8] the reason was in a bug:`$latitudeView` flag was checked before it was changed, the correct code is `if $forking == 1 or $forking == 3 {}` (line 1930)
  - [x] with new `space` functionality introduced i had decided to shrink `system`'s appetite (to improve typesetting alignment) --here is what it was looking like [`iywa`.`space`.`iywa`.`iywa`.`space`.`iywa`] <img width="400" title="space-TODO-shrink_system&#39;s_appetite" src="https://github.com/user-attachments/assets/1ab76608-f747-4e4c-b516-e1d74ed12507" /> then after adding `$frontOffset` and `$backOffset` there was a short-living bug [i had not checked the callee in `iLiner` so every `$newString == false` glyph was doubled at the selector] <img width="400" title="space-TODO-seeing-double_system&#39;s_appetite" src="https://github.com/user-attachments/assets/f35d462e-93be-46ca-998b-f9c7bd112cba" /> after solving that nuisance i have set `$frontOffset = .3` (which was a little too much) <img width="400" title="space-TODO-frontOffset_system&#39;s_appetite" src="https://github.com/user-attachments/assets/85477b87-9f6a-4c1c-a7da-1e33506af295" /> then have set both offsets to a sane value of `.7` (and have gotten a neat view) <img width="400" title="space-TODO-both-Offsets_system&#39;s_appetite" src="https://github.com/user-attachments/assets/99e0dbd8-7f21-4e89-a40f-88e55f66b351" /> but when i have done a rotation of the glyph there was another silly hole found <img width="400" title="space-TODO-hole-in-space_system&#39;s_appetite" src="https://github.com/user-attachments/assets/134d38c2-e7c8-4f70-b3d4-7dbe80893092" /> which was fixed quickly --i have glanced at the previous entry at `moan` (`$name == 0`) and i have locally set `$fork = 0` (so i have gotten another neat view) <img width="400" title="space-TODO-fixed-hole-space_system&#39;s_appetite" src="https://github.com/user-attachments/assets/cc7d629b-6bec-47d2-9b0a-9ce75b4832aa" />
